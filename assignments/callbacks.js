...
getLength(items, lengthWriting)


function last(arr, cb) {
  // last passes the last item of the array into the callback.
  let lastItems = arr.pop()
  cb(lastItems)
}

last(items, lengthWriting)

function sumNums(x, y, cb) {
  // sumNums adds two numbers (x, y) and passes the result to the callback.
  cb(x+y)
}
sumNums(1,5,lengthWriting)
...
multiplyNums(4, 6, lengthWriting)
...
contains('Gum' , items,  lengthWriting)
